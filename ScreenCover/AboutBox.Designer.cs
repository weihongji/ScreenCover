...
namespace ScreenCover
{
	partial class AboutBox
	{
		...
		private void InitializeComponent() {
			...
			this.tableLayoutPanel.Size = new System.Drawing.Size(564, 337);
			...
			this.label3.Text = "Alt + Arrow Keys";
			// 
			// label4
			// 
			...
			this.label5.Text = "Move the cover at arrow direction";
			// 
			// label6
			// 
			...
			this.label6.Text = "Increase cover size at edge specified by arrow";
			// 
			// label7
			// 
			...
			this.label7.Text = "Decrease cover size at edge specified by arrow";
			// 
			// label8
			// 
			...
			this.label8.Text = "Adjust opacity";
			// 
			// lblShortcuts
			// 
